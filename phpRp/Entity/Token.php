...
class Token extends BaseEntity implements JsonSerializable, ArrayAccess
{
    ...
    {
        if(!($issued_at instanceof DateTime)) {
            $issued = new DateTime();
            $issued->setTimestamp($issued_at);
    ...
    {
        if(!($expiration_at instanceof DateTime)) {
            $expires = new DateTime();
            $expires->setTimestamp($expiration_at);
            $this->expiration_at = $expires;
        } else {
